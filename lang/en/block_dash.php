...
$string['ajaxtoomanyicons'] = 'Too many icons ({$a}) to display. Please narrow your search.';
...
$string['assignment_duedate'] = 'Due Date';
$string['assignment_enddate'] = 'End Date';
$string['assignment_mandatory'] = 'Mandatory';
$string['assignment_optional'] = 'Optional';
$string['assignment_priority'] = 'Priority';
$string['assignment_priority_high'] = 'High';
$string['assignment_priority_low'] = 'Low';
$string['assignment_priority_normal'] = 'Normal';
$string['assignment_startdate'] = 'Start Date';
$string['assignment_tags'] = 'Tags';
$string['assignment_type'] = 'Type';
$string['assignmentinformation'] = 'Assignment Information';
$string['assignmenttags'] = 'Assignment tags';
$string['assignmenttags_help'] = "Display only courses from the timetable assignments that match the selected tags. If no tags are selected, all courses assigned to the user will be shown.";
...
$string['availablecirclecolor'] = 'Available';
$string['availablecirclecolor_desc'] = 'Colour for courses that are available to enroll.';
$string['availablecirclecolor_help'] = 'Select the color used to display available courses in circle form on the learning path.';
...
$string['backtoinfoarea'] = 'Back to info area';
...
$string['closesidebar'] = 'Close sidebar';
...
$string['completedcirclecolor'] = 'Completed';
$string['completedcirclecolor_desc'] = 'Colour for courses the user has completed.';
$string['completedcirclecolor_help'] = 'Select the color used to display available courses in circle form on the learning path.';
$string['completedcourse'] = "Completed course";
$string['completedcourseslabel'] = 'Completed Courses';
...
$string['configure_zones_title'] = "Configure Zones";
...
$string['coursecustomcontent'] = 'Course booking content field';
$string['coursecustomcontentdesc'] = 'Select the course custom field that contains booking/custom content for course cards. When set and a course has content in this field, users who are not enrolled will see a "Book now" button that opens the details area.';
...
$string['courseimgsize']      = 'Course size';
$string['courseimgsize_desc'] = 'Select the size of the course image. This affects whether certain visual options are available.';
...
$string['courseshape'] = 'Course shape';
$string['courseshape_desc'] = 'Select the default shape for course images.';
$string['courseshape_help'] = 'Select the shape of the course on the learning path.';
...
$string['coursevisual_help'] = 'Select how the course will appear on the learning path. Only available if size is not "Dot".';
$string['cover'] = "Cover";
...
$string['custom_contents'] = 'Custom contents';
...
$string['customlayouttype'] = 'Type';
$string['customlayouttype_help'] = 'Defines where this custom layout can be used. Block: only listed in the Layout setting of the block. Details area: only listed in the Custom content setting on the Details area tab. Both: listed in both settings.';
$string['customlayouttypeblock'] = 'Block';
$string['customlayouttypeboth'] = 'Both';
$string['customlayouttypedetailsarea'] = 'Details area';
...
$string['datasource:competency_widget'] = 'competency graph widget';
...
$string['datasource:completions_data_source_help'] = 'Users completed courses list.';
...
$string['desktop_learningpath'] = 'Desktop resources';
$string['desktop_learningpath_desc'] = 'Upload files for the Desktop layout.';
$string['desktop_learningpath_help'] = 'Upload one or more files that will be available for the Desktop layout.';
...
$string['details_header'] = 'Details header';
$string['details_link'] = 'Details link';
...
$string['enrollmentoptions:activeenrolment'] = 'Active enrolment';
$string['enrollmentoptions:availableforbooking'] = 'Available for booking';
$string['enrollmentoptions:availableforpurchase'] = 'Available for purchase';
$string['enrollmentoptions:cost'] = '{$a->cost} {$a->currency}';
$string['enrollmentoptions:credits'] = '{$a} credits';
$string['enrollmentoptions:expiredenrolment'] = 'Expired enrolment';
$string['enrollmentoptions:free'] = 'Free';
$string['enrollmentoptions:fromcost'] = 'From {$a->cost} {$a->currency}';
$string['enrollmentoptions:fromcredits'] = 'From {$a} credits';
$string['enrollmentoptions:notavailable'] = 'Not available for enrolment';
$string['enrollmentoptions:open'] = 'Open';
$string['enrollmentoptions:pendingenrolment'] = 'Pending enrolment';
$string['enrollmentoptions:seeoptions'] = 'See options';
$string['enrollmentoptions:upcomingenrolment'] = 'Upcoming enrolment';
...
$string['extralargeimage'] = 'Extra Large';
$string['fade'] = 'Fade';
$string['fade_help'] = 'Enables fade effect on slides transition.';
$string['failed'] = 'Failed';
$string['failedcirclecolor'] = 'Failed';
$string['failedcirclecolor_desc'] = 'Colour for courses the user completed but failed.';
$string['failedcirclecolor_help'] = 'Select the color used to display available courses in circle form on the learning path.';
$string['field'] = 'Field';
...
$string['field:courseimgsize'] = "Course size";
...
$string['field:courseshape'] = 'Course shape';
$string['field:courseshape_help'] = 'Select the shape for course icons. This option is only available when the image size is not set to Dot.';
$string['field:coursesinprogress'] = 'Courses in progress';
$string['field:coursevisual']      = 'Course visual';
$string['field:coursevisual_desc'] = 'Select how the course will appear on the learning path. Only available if size is not "Dot".';
$string['field:currentcoursescount'] = 'Current courses';
$string['field:customorder'] = "Custom order";
$string['field:customorder_help'] = "Enter course IDs separated by commas. These IDs will be used to order the courses in this learning path";
...
$string['field:displaybadges'] = 'Display badges';
$string['field:displaybadges_help'] = 'Display the badges that can be earned in one of the courses of the learning path, greyed out if the badge is not earned yet';
$string['field:displayfaculty'] = 'Display faculty';
$string['field:displayfaculty_help'] = 'Display all users that have the selected role(s) in one of the courses as determined by the conditions of the learning path';
$string['field:displaypathindex'] = 'Display path index';
$string['field:displaypathindex_help'] = 'Display an expandable progress bar for the courses included in the path, color coded by status';
...
$string['field:infoareaposition'] = 'Info area position';
$string['field:infoareaposition_help'] = 'Choose where the info area should be displayed';
$string['field:kpi'] = 'KPI {$a}';
$string['field:kpi1'] = 'Info area KPI 1';
$string['field:kpi2'] = 'Info area KPI 2';
$string['field:kpi3'] = 'Info area KPI 3';
$string['field:kpi4'] = 'Info area KPI 4';
$string['field:kpitype'] = 'KPI 1';
...
$string['field:shapecustomfield'] = 'Select course field for shape';
$string['field:shapecustomfield_help'] = 'Select a custom course field (of type select/menu) to determine the shape of each course. The field value should contain one of: <strong>circle</strong>, <strong>triangle</strong>, <strong>hexagon</strong>, <strong>diamond</strong>, or <strong>star</strong>. If no field is selected or the field value is invalid, courses will use the default shape.<br><br><strong>Example setup:</strong><br>1. Create a custom course field named "Shape"<br>2. Add options: Circle, Triangle, Hexagon, Diamond, Star<br>3. Select that field here<br>4. Set the field value for each course';
...
$string['group_no_children'] = 'This group has no child elements.';
...
$string['infoarea:sidebar'] = 'Sidebar';
$string['infoarea:top'] = 'Top';
$string['initial'] = "Initial";
$string['inprogresscirclecolor'] = 'In progress';
$string['inprogresscirclecolor_desc'] = 'Colour for courses the user has started but not completed.';
$string['inprogresscirclecolor_help'] = 'Select the color used to display available courses in circle form on the learning path.';
...
$string['kpi:badges'] = 'Badges';
$string['kpi:badges_help'] = 'Earned badges out of possible badges that can be collected in the courses contained in the learning path';
$string['kpi:completedcourses'] = 'Completed Courses';
$string['kpi:courses'] = 'Courses';
$string['kpi:courses_help'] = 'Completed courses out of total courses (e.g. 3 / 5)';
$string['kpi:coursespercent'] = 'Courses (%)';
$string['kpi:coursespercent_help'] = 'Completed courses out of total courses as percentage (e.g. 60%)';
$string['kpi:percentagecompleted'] = 'Course Completion';
$string['kpi:period'] = 'Period';
$string['kpi:period_help'] = 'The earliest enrolment start date until the latest enrolment end date of courses in the learning path (e.g. Jun 2025 - Jul 2025)';
$string['kpi:status'] = 'Status';
$string['kpi:status_help'] = 'Indicates if the user has completed all courses that have a due date in the past. If yes, then "On track", if not, "Not on track"';
$string['label'] = 'Label';
...
$string['layoutaccordion'] = 'Accordion (with tables)';
$string['layoutaccordion2'] = 'Accordion';
$string['layoutcards'] = 'Grid';
$string['layoutcards_masonry'] = 'Masonry';
$string['layoutcards_slider'] = 'Slider';
...
$string['layouttwostat'] = 'One figure / other figure';
...
$string['mobile_learningpath'] = 'Mobile resources';
$string['mobile_learningpath_desc'] = 'Upload files for the Mobile layout.';
$string['mobile_learningpath_help']  = 'Upload one or more files that will be available for the Mobile layout.';
...
$string['noiconselected'] = 'No icon selected';
$string['none'] = 'None';
...
$string['notontrack'] = 'Not on track';
$string['notstartedcirclecolor'] = 'Enrolled';
$string['notstartedcirclecolor_desc'] = 'Select the colour used for courses that have not been started.';
$string['notstartedcirclecolor_help'] = 'Select the color used to display available courses in circle form on the learning path.';
...
$string['positioning_path'] = 'On the path';
$string['positioning_zones'] = 'In zones';
$string['prerequisitesfilter'] = 'Prerequisites Filter';
...
$string['resourcesheading_desc'] = 'Upload files for each device that can be used in the Dash block preferences.';
...
$string['selectprerequisitecourses'] = 'Select courses whose prerequisites should be shown';
$string['selectprerequisitecourses_help'] = 'This dropdown lets you choose courses for which you want to show prerequisites. You can select multiple courses.';
$string['selfallocationwithkey'] = 'Sigup (Key required)';
$string['setup'] = 'Setup';
$string['shape:circle'] = 'Circle';
$string['shape:custom'] = 'Shape set for ({$a})';
$string['shape:diamond'] = 'Diamond';
$string['shape:hexagon'] = 'Hexagon';
$string['shape:star'] = 'Star';
$string['shape:svgshape'] = 'Shape of the vector element';
$string['shape:triangle'] = 'Triangle';
$string['shapemapping_header'] = 'Shape Mapping';
$string['shapemapping_info'] = 'Map each option from the <strong>{$a}</strong> field to a shape:';
...
$string['sourcecore'] = 'Moodle core';
$string['sourcefablank'] = 'FontAwesome Blank';
$string['sourcefabrand'] = 'FontAwesome Brands';
$string['sourcefasolid'] = 'FontAwesome Solid';
$string['speed'] = 'Transition speed (ms)';
$string['speed_help'] = 'Set the speed of the slide transition in milliseconds.';
$string['standard_terms'] = 'Standard terms';
$string['standard_terms_desc'] = 'Global standard terms content to be displayed in the Details area when selected. Supports HTML, filters and embedded images/files.';
$string['standard_terms_none'] = 'None';
...
$string['supported_zone_elements'] = 'Supported zone elements';
$string['supported_zone_elements_desc'] = 'Comma-separated list of SVG elements that can be used as zones';
...
$string['tabdetailsarea'] = 'Details area';
$string['tabfields'] = 'Fields';
$string['tabfilters'] = 'Filters';
$string['tabgeneral'] = 'Layout';
...
$string['tablet_learningpath_desc'] = 'Upload files for the Tablet layout.';
$string['tablet_learningpath_help']  = 'Upload one or more files that will be available for the Tablet layout.';
$string['tags'] = 'Tags';
$string['templatevars'] = 'Placeholders';
$string['templatevars_course'] = 'Course Information';
$string['templatevars_user'] = 'User Profile';
$string['templatevars_user_help'] = 'User profile placeholders';
$string['testhelpbutton'] = 'This is for testing';
$string['textcolor'] = 'Text color';
$string['timemodified'] = "Time modified";
$string['timesinceevent'] = 'Time since event';
$string['tinyimage'] = 'Tiny';
...
$string['unavailablecirclecolor'] = 'Not available';
$string['unavailablecirclecolor_desc'] = 'Select the colour used for Not available (not started) course circles.';
$string['unavailablecirclecolor_help'] = 'Select the color used to display available courses in circle form on the learning path.';
...
$string['visual:courseimg']  = 'Course image';
$string['visual:courseimg_desc'] = 'The course will use the course summary image with an outline/border in the color determined by the status.';
$string['visual:custom'] = 'Visual set for ({$a})';
$string['visual:customfield']      = 'Determined by custom field';
$string['visual:customfield_desc'] = 'The course will use the icon associated with the selected custom course field on top of the background color determined by the status.';
$string['visual:none']        = 'None';
$string['visual:none_desc']   = 'The course will be displayed without additional visual, just with the color determined by the status.';
$string['visual:number']      = 'Number';
$string['visual:number_desc'] = 'The course will display its order number on top of the background color determined by the status.';
$string['wholecourse'] = 'Whole course';
$string['widget'] = 'Widget';
$string['widget:activitycompletion'] = "Activity completion";
$string['widget:activitycompletion_help'] = "Activity completion reports.";
...
$string['zone_enabled'] = 'Enabled';
$string['zone_id'] = 'ID';
$string['zone_type'] = 'Type';
$string['zone_type_circle'] = 'Circle';
$string['zone_type_ellipse'] = 'Ellipse';
$string['zone_type_group'] = 'Group';
$string['zone_type_mask'] = 'Mask';
$string['zone_type_path'] = 'Path';
$string['zone_type_polygon'] = 'Polygon';
